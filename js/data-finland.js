...
window.SE_MAP_DATA.finland = {
  ...
  categories: [
    { id: "city", nameKo: "도시·건축", nameEn: "City & Architecture", varName: "--c1" },
    { id: "design", nameKo: "디자인·문화", nameEn: "Design & Culture", varName: "--c2" },
    { id: "arctic", nameKo: "북극·오로라·산타", nameEn: "Arctic & Aurora", varName: "--c3" },
    { id: "nature", nameKo: "호수·자연", nameEn: "Lakes & Nature", varName: "--c4" },
  ],

  cities: [
    { id: "helsinki", nameKo: "헬싱키", nameEn: "Helsinki", lon: 24.9384, lat: 60.1699 },
    { id: "porvoo", nameKo: "포르보", nameEn: "Porvoo", lon: 25.6650, lat: 60.3925 },
    { id: "turku", nameKo: "투르쿠", nameEn: "Turku", lon: 22.2666, lat: 60.4518 },
    { id: "tampere", nameKo: "탐페레", nameEn: "Tampere", lon: 23.7610, lat: 61.4978 },
    { id: "savonlinna", nameKo: "사본린나", nameEn: "Savonlinna", lon: 28.8869, lat: 61.8687 },
    { id: "rovaniemi", nameKo: "로바니에미 (산타 마을)", nameEn: "Rovaniemi", lon: 25.7294, lat: 66.5039 },
    { id: "saariselka", nameKo: "사리셀카", nameEn: "Saariselkä", lon: 27.4083, lat: 68.4200 },
  ],
  ...
  attractions: [
    ...
    {
      id: "suomenlinna", cityId: "helsinki", category: "city",
      nameKo: "수오멘린나 요새", nameEn: "Suomenlinna",
      history: "18세기에 여섯 개의 섬에 걸쳐 지은 해상 요새로, 스웨덴·러시아·핀란드의 역사가 얽혀 있다. 1991년 유네스코 세계유산에 등재됐다.",
      intro: "성벽과 대포, 옛 병영과 카페가 있는 섬 요새로, 지금도 주민이 산다. 헬싱키 앞바다에서 산책·피크닉하기 좋다.",
      tip: "시장 광장에서 페리로 약 15분이면 닿는다(시내 교통권 사용). 섬 전체를 걸어서 둘러볼 수 있다.",
    },

    // ---- Porvoo ----
    {
      id: "porvoo-oldtown", cityId: "porvoo", category: "design",
